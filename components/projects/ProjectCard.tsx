  ...
  return (
    ...
    >
      <a
        ...
        target="_blank"
        className={`w-full max-w-[365px] min-h-[250px] overflow-hidden relative rounded-xl border-fun-gray border p-2 transition hover:-translate-y-2 hover:opacity-75 hover:border-fun-pink will-change-projectCard`}
      >
        <img
